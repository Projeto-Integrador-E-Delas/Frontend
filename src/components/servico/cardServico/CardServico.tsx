    ...
    <div className="rounded-lg transform transition duration-300">
      ...
      <div className="rounded-lg flex flex-col gap-1">
        ...
        <div className="flex gap-2 mt-3">
          ...
          <div className="flex">
            <Link to={`/editarServico/${post.id}`} className="text-white bg-purple-600 hover:bg-pruple-700 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-6 py-2.5 text-center inline-flex items-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">
              <button>Editar</button>
            </Link>
          </div>
          <div>
            <Link to={`/deletarServico/${post.id}`} className="text-white bg-purple-600 hover:bg-pruple-700 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-6 py-2.5 text-center inline-flex items-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">
